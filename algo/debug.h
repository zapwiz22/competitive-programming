...
template <typename T, size_t N> void _print(const array<T, N> &arr);
...
template <typename T> void _print(const list<T> &lst);

template <typename T> void _print(const forward_list<T> &flst);

template <size_t N> void _print(const bitset<N> &bs);

template <typename... Args> void _print(const tuple<Args...> &t);

template <typename T> void _print(const complex<T> &c);
